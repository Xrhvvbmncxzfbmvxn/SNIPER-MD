 ...
 * @author : 𝖕𝖗𝖎𝖒𝖊 𝕰𝖒𝖒𝖆𝖓𝖚el <https://github.com/kingmalvn>
...
const ownerNumber = ['24174704164']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("EMMA-XD~", '');
...
console.log("CONNECTING SNIPER-MD 🧬...");
...
console.log('SNIPER-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ SNIPER-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb5sZ0dLY6dDyDEsbp3J*
...
if(senderNumber.includes("24174704164")){
if(isReact) return
m.react("🦋")
   }
